...
// ===============================================================================================
//
// WARNING: This file was generated by JsRouting and should NOT be overridden.
//          When this file is compromised,  the file will be overridden and changes will be lost.
//
// ===============================================================================================

// The following code is the jQuery plugin that handles most of the routing logic.
// JQUERY IS REQUIRED!
    ...
    var Route = function (pattern) {
        ...
        this.accept = function (data) {
            ...
            return data.controller &&
                   data.action &&
                   (!ArrayAny(this.params,"area") || data.area) &&
                   (this.defaultValues.controller === data.controller || ArrayAny(this.params,"controller")) &&
                   (this.defaultValues.action === data.action || ArrayAny(this.params,"action")) &&
                   !ArrayAny(this.constraints, function (c) { return !c(data); });
        };
    ...
    var Result = function (r, data) {
        ...
        var getData = function (extra) {
            ...
            $.each($.extend({}, r.defaultValues, data), function (name, value) {
                if (!ret[name] && !ArrayAny(r.params, name)) {
                    ret[name] = value;
                }
            });
            return ret;
